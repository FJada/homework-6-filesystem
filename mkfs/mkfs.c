...
unsigned int ialloc(unsigned short type) {
  ...
  din.createTime.second = date->tm_sec;
  din.createTime.minute = date->tm_min;
  din.createTime.hour = date->tm_hour;
  din.createTime.day = date->tm_mday;
  din.createTime.month = date->tm_mon + 1;
  din.createTime.year = date->tm_year + 1900; // fixes time zone
